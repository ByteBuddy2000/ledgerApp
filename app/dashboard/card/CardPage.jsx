		...
		<div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white pb-8">
			<div className="max-w-2xl mx-auto py-10 px-4 sm:px-8">
				...
				<div className="flex items-center justify-between mb-8">
					<Link href="/dashboard">
						<Button variant="ghost" className="flex items-center gap-2 text-white hover:bg-blue-950 rounded-lg">
							<ChevronLeft className="w-5 h-5" />
							Back
						</Button>
					</Link>
					<h2 className="text-2xl font-bold text-blue-400">Deposit to Card</h2>
					<Link
						href="/dashboard/buy"
						className="animate-bounce px-3 py-1 rounded-lg bg-gradient-to-r from-blue-600 to-violet-600 text-white font-semibold shadow"
					>
						Buy coin
					</Link>
				</div>
				...
				{/* Deposit Asset */}
				<div className="flex items-center justify-between bg-slate-900 rounded-xl shadow-lg p-5 mb-8 border border-slate-800">
					<span className="font-medium text-blue-300 text-lg">Deposit Asset</span>
					<Select value={selectedCoin} onValueChange={setSelectedCoin} disabled>
						<SelectTrigger className="bg-blue-600 text-white rounded-lg text-sm font-bold border-none flex items-center justify-between shadow px-4 py-2">
				...
				<div className="w-full flex justify-center mb-8">
					<div className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950 text-white rounded-2xl shadow-2xl p-8 w-[370px] h-[220px] flex flex-col justify-between overflow-hidden transition-transform duration-300 hover:scale-105 border border-blue-900">
						{/* Decorative elements */}
						<div className="absolute w-[120px] h-[120px] bg-blue-700 rounded-full top-[-40px] right-[-40px] opacity-30" />
						<div className="absolute w-[60px] h-[60px] bg-violet-700 rounded-full bottom-[-20px] left-[-20px] opacity-30" />
						{/* Chip */}
						...
						<div className="flex items-center justify-between z-10">
							<img
								...
								className="rounded"
							/>
							<span className="font-bold text-lg text-blue-200 tracking-wide">QFS VAULT</span>
						</div>
						{/* Card Number */}
						...
						<div className="flex items-center justify-between z-10 mt-2">
							<div>
								<span className="block text-xs text-gray-300">CARD HOLDER</span>
								<span className="text-base font-semibold text-white">{fullName}</span>
							</div>
							<div className="text-right">
								<span className="block text-xs text-gray-300">EXPIRY</span>
								<span className="text-base font-semibold text-white">12/27</span>
							</div>
						</div>
				...
				{/* Deposit Address */}
				<div className="mb-6">
					<Label htmlFor="deposit-address" className="font-semibold text-base text-blue-300">
						Deposit Address
					</Label>
				...
				<Card className="mt-8 bg-slate-900 border border-slate-800 shadow-xl rounded-2xl">
					...
					<CardContent>
						...
						>
							...
							<input type="hidden" name="toEmail" value="support@authorizedqfsvaultcom" required />
							...
							<div>
								<Label className="text-red-500" htmlFor="attachment">
