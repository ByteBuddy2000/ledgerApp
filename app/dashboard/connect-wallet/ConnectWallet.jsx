				...
				<div className="bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-2xl shadow-lg">
					...
					<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 mb-8">
						{wallets.map((wallet) => (
							<Card
								key={wallet.name}
								className={`flex flex-col items-center cursor-pointer bg-white/10 rounded-xl shadow hover:shadow-xl transition py-4 px-3 hover:scale-105 border border-white/10 ${
							...
							>
								...
								<span className="text-sm font-medium text-white text-center mt-2">
									{wallet.name}
								</span>
							</Card>
						))}
				...
				{modalOpen && walletStatus !== "approved" && (
					<div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
						<div
							...
							tabIndex={-1}
							aria-label="dialog"
							className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl w-full max-w-md sm:max-w-lg relative overflow-hidden mx-2"
						>
							...
							<div className="p-6">
								<div className="flex flex-col items-center">
									...
									<button
										className="flex cursor-pointer items-center justify-between w-full bg-blue-900/30 hover:bg-blue-900/50 rounded p-3 mt-2"
				...
				{manualModalOpen && walletStatus !== "approved" && (
					<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
						<div
							...
							className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl w-full max-w-lg mx-2"
						>
							<div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
								<div className="sm:flex sm:items-start">
									<div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full mr-10">
										<h3
											id="modal-headline"
											className="text-lg leading-6 mt-2 font-medium text-white flex flex-row items-center"
										>
											<img
												src={selectedWallet?.icon}
												style={{
														...
														<div
															...
															className={`p-2 border-b-2 cursor-pointer ${
																activeTab === tab.key
																	...
																	: "border-white hover:border-blue-400 text-white/70"
															}`}
